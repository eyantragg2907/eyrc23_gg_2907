...
def MK_block(input_):
    ...
    out_2_3 = Conv2D(48, kernel_size=(3, 3), activation="relu", padding="same")(
        out_1_b_3
    )
    out_2_5_2 = Conv2D(24, kernel_size=(5, 5), activation="relu", padding="same")(
        out_1_b_3
    )
    out_2_3 = Concatenate()([input_, out_2_3, out_2_5_2, out_1_b_3])

    out_2_5 = Conv2D(36, kernel_size=(5, 5), activation="relu", padding="same")(
        out_1_b_3_5
    )
    out_2_7 = Conv2D(18, kernel_size=(7, 7), activation="relu", padding="same")(
        out_1_b_5_7
    )
    ...
    out_4_3 = Conv2D(72, kernel_size=(3, 3), activation="relu", padding="same")(
        out_3_b_5_7
    )
    out_4_b_3 = BatchNormalization()(out_4_3)

    out = Concatenate()(
        [input_, out_3_b_3, out_1_b_3, out_1_b_3_5, out_1_b_5_7, out_3_b_5_7, out_4_b_3]
    )
...
def build_model():
    ...
    input_ = tf.keras.layers.Rescaling(1.0 / 255)(input_)
...
def load_data(option):
    if option == "fashion":
        ...
        x_train, y_train = mnist_reader.load_data(
            "oracle-mnist/data/oracle", kind="train"
        )
