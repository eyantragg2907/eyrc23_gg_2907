...
def get_robot_coords_and_frame(
    ...
    if save_images:
        ...
        frame, side_len = transform_frame(frame, get_high_res=True)  # transform to fit conditions
...
"""
def transform_frame(frame: np.ndarray, get_high_res: bool = False) -> tuple[np.ndarray, int]:
